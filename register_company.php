                    ...
                    if ($_SERVER['REQUEST_METHOD'] == "POST") {
                        ...
                        && !empty($username) && !empty($company_name) && !empty($phone_number) && !empty($city) && !empty($price)){
                            if($password1 == $password2){
                                ...
                                $query_1 = "INSERT INTO users(username, email, password, name, surname, role, profile_picture_path)
                                          VALUES('$username', '$email', '$password1', '$name', '$surname', 'company', 'profilepictures/me.png')";
                                mysqli_query($con, $query_1);
                                $query_2 = "INSERT INTO company(company_name, city, price, phone_number)
                                            VALUES('$company_name', '$city', '$price', '$phone_number')";
